# Have to re-run the model training with the fixed genotype files
...
mclapply(1:nfold, function(foldnum){
  setwd('~/plateletExpressionModelling/')
  ...
  #### Run predixcan with the created model to predict expression in the fullset
